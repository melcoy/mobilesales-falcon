...
class VisitPlanEdit extends StatefulWidget {
  @override
  _VisitPlanAddState createState() => _VisitPlanAddState();
}

class _VisitPlanAddState extends State<VisitPlanEdit> {
                      ...
                      IconButton(
                          ...
                          onPressed: () async {
                            ...
                            if (idCustomerPage != null) {
                              print(idCustomerPage[0]);

                              setState(() {
                                customerId = idCustomerPage[0].toString();
                                customerName = idCustomerPage[1].toString();
